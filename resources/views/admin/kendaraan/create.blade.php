...
<div class="max-w-3xl mx-auto">
    <h2 class="text-2xl font-bold text-gray-700 mb-6">Tambah Kendaraan</h2>
        ...
        <form method="POST" action="{{ route('admin.kendaraan.store') }}">
            ...
            <div class="mb-4">
                ...
                <div class="flex gap-2">
                    <input type="text" id="id_premotor" name="id_premotor" value="{{ old('id_premotor') }}"
                        placeholder="Isi atau biarkan kosong untuk generate otomatis"
